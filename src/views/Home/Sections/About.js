              ...
              <div style={styles.root}>
                ...
                <div className="w3-row-padding">
                    ...
                    <div className="w3-third" style={{textAlign: "center"}}>
                        ...
                        <h3>Pesquisa</h3>
                        <p style={styles.small}>Nas áreas de Design Digital, Engenharia de Software, Engenharia de Computação
                            Ciência da Computação, Redes de Computadores e Sistemas de Informação.</p>
                    </div>
                    <div className="w3-third" style={{textAlign: "center"}}>
