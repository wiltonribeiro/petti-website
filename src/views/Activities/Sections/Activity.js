    ...
    return (
        <div>
            ...
            <div className="w3-row-padding" style={{padding:10}}>
                {/*first row*/}
                <div className="w3-third" style={{position:"relative", textAlign:"center"}} onClick={() => this.handleOpen(contentActivity.ecopet)}>
                    <img src={ecopet} className="blurImage" alt={contentActivity.ecopet.title} style={{width:"80%"}}/>
                    <div style={styles.button} className="buttonImage">VER MAIS</div>
                </div>
                <div className="w3-third" style={{position:"relative", textAlign:"center"}} onClick={() => this.handleOpen(contentActivity.flisol)} >
                    <img src={flisol} className="blurImage" alt={contentActivity.ecopet.title} style={{width:"80%"}}/>
                    <div style={styles.button} className="buttonImage">VER MAIS</div>
                </div>
                <div className="w3-third" style={{position:"relative", textAlign:"center"}} onClick={() => this.handleOpen(contentActivity.infogirl)} >
                    <img src={infogirl} className="blurImage" alt={contentActivity.ecopet.title} style={{width:"80%"}}/>
                    <div style={styles.button} className="buttonImage">VER MAIS</div>
                </div>
                {/*second row*/}
                <div className="w3-third" style={{position:"relative", textAlign:"center"}} onClick={() => this.handleOpen(contentActivity.gamenight)}>
                    <img src={gamenight} className="blurImage" alt={contentActivity.ecopet.title} style={{width:"80%"}}/>
                    <div style={styles.button} className="buttonImage">VER MAIS</div>
                </div>
                <div className="w3-third" style={{position:"relative", textAlign:"center"}} onClick={() => this.handleOpen(contentActivity.englishclub)} >
                    <img src={englishclub} className="blurImage" alt={contentActivity.ecopet.title} style={{width:"80%"}}/>
                    <div style={styles.button} className="buttonImage">VER MAIS</div>
                </div>
                <div className="w3-third" style={{position:"relative", textAlign:"center"}} onClick={() => this.handleOpen(contentActivity.recepcao)} >
                    <img src={recepcao} className="blurImage" alt={contentActivity.ecopet.title} style={{width:"80%"}}/>
                    <div style={styles.button} className="buttonImage">VER MAIS</div>
                </div>
                {/*third row*/}
                <div className="w3-third" style={{position:"relative", textAlign:"center"}} onClick={() => this.handleOpen(contentActivity.programacao)}>
                    <img src={programacao} className="blurImage" alt={contentActivity.ecopet.title} style={{width:"80%"}}/>
                    <div style={styles.button} className="buttonImage">VER MAIS</div>
                </div>
                <div className="w3-third" style={{position:"relative", textAlign:"center"}} onClick={() => this.handleOpen(contentActivity.microcontroladores)} >
                    <img src={microcontroladores} className="blurImage" alt={contentActivity.ecopet.title} style={{width:"80%"}}/>
                    <div style={styles.button} className="buttonImage">VER MAIS</div>
                </div>
                <div className="w3-third" style={{position:"relative", textAlign:"center"}} onClick={() => this.handleOpen(contentActivity.seminarios)} >
                    <img src={seminarios} className="blurImage" alt={contentActivity.ecopet.title} style={{width:"80%"}}/>
                    <div style={styles.button} className="buttonImage">VER MAIS</div>
                </div>
                <div className="w3-third" style={{position:"relative", textAlign:"center"}} onClick={() => this.handleOpen(contentActivity.obi)} >
                    <img src={obi} className="blurImage" alt={contentActivity.ecopet.title} style={{width:"80%"}}/>
                    <div style={styles.button} className="buttonImage">VER MAIS</div>
                </div>
            </div>
        </div>
